...
int main() {
    ...
    while(tests--){
        ...
        if(change=='.' && temp=='.') {cout<<answer<<endl; continue;}
        if(change=='.'){
        ...
        }//else no change in answer
        //previous out of limit solution code: 32202716 to understand logic
